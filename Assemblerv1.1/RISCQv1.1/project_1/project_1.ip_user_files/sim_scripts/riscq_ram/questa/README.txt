...
#
# Generated by export_simulation on Fri Nov 15 09:42:17 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './riscq_ram.sh' script.

./riscq_ram.sh -reset_run
...
./riscq_ram.sh -noclean_files

For more information on the script, please type './riscq_ram.sh -help'.
