...
HD_PWD='F:/qbit/qubit_1.0/RISCQv1.1/project_1/project_1.runs/fifo_trans_width_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_trans_width.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_trans_width.tcl
