...
elaborate()
{
  xelab --relax --debug typical --mt auto -L gtwizard_ultrascale_v1_7_7 -L xil_defaultlib -L gig_ethernet_pcs_pma_v16_1_7 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gig_ethernet_pcs_pma_0 xil_defaultlib.gig_ethernet_pcs_pma_0 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb gig_ethernet_pcs_pma_0.wdb xsim.dir)
