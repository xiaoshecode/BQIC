...
#
# Generated by export_simulation on Tue Nov 19 20:24:20 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './riscq_init_fifo.sh' script.

./riscq_init_fifo.sh -reset_run
...
./riscq_init_fifo.sh -noclean_files

For more information on the script, please type './riscq_init_fifo.sh -help'.
