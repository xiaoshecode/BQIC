...
#
# Generated by export_simulation on Thu Nov 14 16:26:22 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './riscq_rom.sh' script.

./riscq_rom.sh -reset_run
...
./riscq_rom.sh -noclean_files

For more information on the script, please type './riscq_rom.sh -help'.
