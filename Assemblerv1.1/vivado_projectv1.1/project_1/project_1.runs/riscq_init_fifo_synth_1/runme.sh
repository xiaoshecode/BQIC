...
HD_PWD='F:/qbit/qubit_1.0/RISCQv1.1/project_1/project_1.runs/riscq_init_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscq_init_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscq_init_fifo.tcl
