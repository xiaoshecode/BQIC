...
HD_PWD='F:/qbit/qubit_1.0/RISCQ/project_1/project_1.runs/riscq_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscq_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscq_ram.tcl
